...
//            recyclerView= (RecyclerView) itemView.findViewById(R.id.container);
        ...
        public void bindRecycler(Long time) {
            ...
            for(int i=0; i<sets.size(); i++) {
                View v =LayoutInflater.from(getActivity()).inflate( R.layout.custom_timeline_component_row, linearLayout,false);
    ...
    class MyAdapter extends RecyclerView.Adapter<MyViewHolder> {
        ...
        public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            return new MyViewHolder(inflater.inflate(R.layout.cutom_timeline_row, parent, false));
        }
