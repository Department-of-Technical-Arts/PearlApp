        ...
        StringRequest request = new StringRequest(Request.Method.POST, ControllerConstant.url, new Response.Listener<String>() {
            ...
            public void onResponse(String s) {
                ...
                try {
                    ...
                    if (object.getString("error").equals("false") && object.getString("tag").equals("token")) {
                        sharedPreferences.edit().putBoolean(ControllerConstant.SENT_TOKEN_TO_SERVER, true).apply();
                        Log.e("token", "received");
                    }
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError volleyError) {
                        Log.e("Token not sent", volleyError.toString());
                    }
                }) {
            @Override
