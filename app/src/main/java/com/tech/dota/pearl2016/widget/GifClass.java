package com.tech.dota.pearl2016.widget;
...
/**
 * Created by Tejeshwar Reddy on 12-03-2016.
 */
public class GifClass extends View {
    ...
    public GifClass(Context context) {
        this(context, null);
    }

    public GifClass(Context context, AttributeSet attrs) {
        this(context, attrs, R.styleable.CustomTheme_gifMoviewViewStyle);
    }

    public GifClass(Context context, AttributeSet attrs, int defStyle) {
